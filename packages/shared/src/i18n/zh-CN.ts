...
export const zhCN = {
  infographic: {
    ...
    historyTitle: "AI 对话记录", historyGenerated: "已生成「{{title}}」", historyRefined: "已修改「{{title}}」", historyUndone: "这次修改已撤回",
    ...
    invalidSyntax: "信息图语法无效，请检查后重试。", renderError: "信息图渲染失败，请调整语法或模板。",
