...
export const enUS = {
  infographic: {
    ...
    historyTitle: "AI conversation history", historyGenerated: "Generated “{{title}}”", historyRefined: "Revised “{{title}}”", historyUndone: "This revision was undone",
    ...
    invalidSyntax: "The infographic syntax is invalid. Check it and try again.", renderError: "Rendering failed. Adjust the syntax or template.",
    ...
    officialTemplates: "AntV templates ({{count}})", searchTemplates: "Search template IDs", templateCategory: "Template category", chooseCategory: "Which infographic type fits this content?", allCategories: "All categories", chartCategory: "Chart", comparisonCategory: "Comparison", hierarchyCategory: "Hierarchy", listCategory: "List", quadrantCategory: "Quadrant", relationCategory: "Relation", sequenceCategory: "Sequence",
